...
const file_user_user_proto_rawDesc = "" +
	"\n" +
	"\x0fuser/user.proto\x12\x04user\"_\n" +
	...
	"\x05valid\x18\x03 \x01(\bR\x05valid2\xbd\x01\n" +
	"\x04User\x129\n" +
...
var file_user_user_proto_depIdxs = []int32{
	...
	4, // 2: user.User.ValidateToken:input_type -> user.ValidateTokenRequest
	1, // 3: user.User.Register:output_type -> user.RegisterResponse
	3, // 4: user.User.Login:output_type -> user.LoginResponse
	5, // 5: user.User.ValidateToken:output_type -> user.ValidateTokenResponse
